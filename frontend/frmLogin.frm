...
Private Sub cmdOK_Click()
   ...
   gClsConn.getDbConn
    ...
    gQuery = "SELECT * FROM team_master WHERE name = '" & txtUserName & "' AND [password] = '" & txtPassword & "' "
    ...
    Else
        ...
        team_id = gResult.GetValue(1, "team_id")
        team_name = gResult.GetValue(1, "name")
        team_rank = gResult.GetValue(1, "rank")
        product_id = gResult.GetValue(1, "product_id")
        capacity = gResult.GetValue(1, "capacity")
        plant_cost = gResult.GetValue(1, "plant_cost")
        country_id = gResult.GetValue(1, "country_id")
        Me.Hide
        frmMain.Show
    End If
